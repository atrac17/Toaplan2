...
xst -ifn xst.scr
move jtgng_pll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\jtgng_pll_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc jtgng_pll_exdes.ucf jtgng_pll_exdes

echo 'Running map'
map -timing -pr b jtgng_pll_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm jtgng_pll_exdes -w routed.ncd routed.v
cd ..
